  ...
  return (
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column', background: t.bg }}>
      ...
      <div style={{
        ...
        <div style={{ fontFamily: "'Anton', sans-serif", fontSize: 18, letterSpacing: '.04em', textTransform: 'uppercase', color: t.ink }}>Achievements</div>
      </div>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '22px 22px 28px', scrollbarWidth: 'none' }}>
        ...
        <div style={{
          ...
          border: `1px solid ${t.line}`, marginBottom: 24,
        }}>
          <div style={{
            fontFamily: "'Anton', sans-serif", fontSize: 18, textTransform: 'uppercase', color: t.ink,
          }}>
            {unlockedCount} / {total} Unlocked
          </div>
          <div style={{
            width: '100%', height: 6, borderRadius: 3, background: t.chip,
                ...
                return (
                  <div key={def.id} style={{
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <div style={{
                        fontSize: 11, fontWeight: 600, color: t.sub, marginTop: 2,
                      }}>{def.description}</div>
                      {unlocked && unlockedAt && (
                        <div style={{
                          fontSize: 10, fontWeight: 700, color: t.accent, marginTop: 3,
